...
{
    public VideoDownloadPreference(
    ...
    public void Deconstruct(
        out Container PreferredContainer,
        out VideoQualityPreference PreferredVideoQuality
    )
    {
        PreferredContainer = this.PreferredContainer;
